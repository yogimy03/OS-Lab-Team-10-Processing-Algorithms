...
public class fcfs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FCFS SCHEDULING ALGORITHM");
    ...
    private void computeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_computeActionPerformed
        ...
        seek_sequence.setText(Arrays.toString(arr));
        }
    ...
    private void graphActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_graphActionPerformed
        ...
        if (head.getText().equals("") || jTable1.getRowCount()==0) {
            ...
            for (int i=0 ; i<arr.length; i++) {
                dataset.addValue ((Number) arr[i],"Process",i+2);
            }

            JFreeChart chart = ChartFactory.createLineChart("FCFS Disk Scheduling", "", "Disk Request", dataset, PlotOrientation.HORIZONTAL, true, true, false);
