 ...
 * @author Yogi
 */
public class ljf_process extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(30, 70, 790, 300);
        ...
        Clear.setBounds(640, 460, 170, 30);
        ...
        Execute.setBounds(240, 500, 100, 30);
        ...
        graph.setBounds(370, 500, 90, 30);

        close1.setBackground(new java.awt.Color(0, 0, 0));
        close1.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        close1.setBounds(490, 500, 90, 30);
        ...
        Remove.setBounds(640, 380, 170, 30);
        ...
        jLabel6.setBounds(80, 0, 770, 480);
        ...
        jLabel7.setBounds(0, 470, 410, 90);
        ...
        jLabel8.setBounds(390, 450, 460, 110);

        jPanel1.setLayout(new javax.swing.BoxLayout(jPanel1, javax.swing.BoxLayout.LINE_AXIS));
        getContentPane().add(jPanel1);
        jPanel1.setBounds(480, 170, 370, 210);
...
//        this.setDefaultCloseOperation(this.EXIT_ON_CLOSE);
        ...
        JFreeChart jchart = ChartFactory.createBarChart("Longest Job First", "Processes", "Turn Around TIme", dcd, PlotOrientation.HORIZONTAL, true, true, true);
        CategoryPlot plot = jchart.getCategoryPlot();
        BarRenderer renderer = (BarRenderer) plot.getRenderer();
        Color color = new Color(25, 32, 159);
        renderer.setSeriesPaint(0, color);
        plot.setRangeGridlinePaint(Color.BLACK);
        ChartFrame chartfrm = new ChartFrame("Longest Job First", jchart, true);
...
//        jPanel1.updateUI();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ljf_process.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ljf_process().setVisible(true);
            }
        });
    }
