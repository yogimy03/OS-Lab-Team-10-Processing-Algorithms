...
public class scan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SCAN SCHEDULING ALGORITHM");
    ...
    private void graphActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_graphActionPerformed
        ...
        if (head.getText().equals("") || jTable1.getRowCount()==0) {
            ...
            JFreeChart chart = ChartFactory.createLineChart("SCAN Disk Scheduling", "", "Disk Request", dataset, PlotOrientation.HORIZONTAL, true, true, false);
