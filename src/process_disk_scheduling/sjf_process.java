 ...
 * @author Yogi
 */
public class sjf_process extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Process Number", "Arrival Time", "Burst Time", "I/O Burst Time", "Burst Time", "Ccompletion Time", "Turn Around Time", "Waiting Time"
            }
        ) {
        ...
        jScrollPane1.setBounds(20, 80, 810, 310);
        ...
        AT.setBounds(220, 430, 50, 30);

        jLabel9.setFont(new java.awt.Font("Comic Sans MS", 3, 29)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("SHORTEST JOB FIRST ALGORITHM");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(160, 20, 580, 41);
        ...
        close.setBounds(510, 560, 120, 30);
        ...
        graph.setBounds(360, 560, 120, 30);
        ...
        Clear.setBounds(660, 510, 160, 30);
        ...
        Execute.setBounds(200, 560, 130, 30);
        ...
        jLabel8.setBounds(410, 460, 440, 150);
        ...
        jLabel7.setBounds(0, 450, 430, 160);
        ...
        jLabel6.setBounds(120, 0, 730, 490);
    ...
    private void ExecuteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExecuteActionPerformed
        ...
        java.util.List<Integer> q = new LinkedList<>();
        for(int i=0;i<r;i++){
...
//        jfrm2.setVisible(true);
    ...
    private void graphActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_graphActionPerformed
        ...
        JFreeChart jchart = ChartFactory.createBarChart("Shortest Job First", "Processes", "Turn Around TIme", dcd, PlotOrientation.HORIZONTAL, true, true, true);
        CategoryPlot plot = jchart.getCategoryPlot();
        BarRenderer renderer = (BarRenderer) plot.getRenderer();
        Color color = new Color(25, 32, 159);
        renderer.setSeriesPaint(0, color);
        plot.setRangeGridlinePaint(Color.BLACK);
        ChartFrame chartfrm = new ChartFrame("Shortest Job First", jchart, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sjf_process.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sjf_process().setVisible(true);
            }
        });
    }
