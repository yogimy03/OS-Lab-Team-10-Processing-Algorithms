 ...
 */
public class c_scan extends javax.swing.JFrame {
    DefaultTableModel tbmodel;
    /**
     * Creates new form c_scan
     */
    public c_scan() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("C-SCAN SCHEDULING ALGORITHM");
    ...
    private void graphActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_graphActionPerformed
        ...
        if (head.getText().equals("") || jTable1.getRowCount()==0) {
            ...
            JFreeChart chart = ChartFactory.createLineChart("C-SCAN Disk Scheduling", "", "Disk Request", dataset, PlotOrientation.HORIZONTAL, true, true, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(c_scan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
